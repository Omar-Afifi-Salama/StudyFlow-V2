...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      // Removed data-[state=active]:shadow-sm to prevent size change
      // Ensured py-2 (consistent with original attempt, py-3 was in prompt but py-2 is in original UI component)
      className
    )}
    {...props}
  />
